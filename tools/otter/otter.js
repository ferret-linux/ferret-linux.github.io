document.addEventListener("DOMContentLoaded", () => {
  ...
  const sequence = [
    { input: "otter registry list", output: "arch  ubuntu  fedora  debian  kali  alpine  void  gentoo  ..." },
    { input: "otter assemble manifest.toml", output: "→ assembling arch-dev ... done\n→ assembling fedora-work ... done" },
    { input: "otter inspect arch-dev", output: "runtime: podman  |  status: running  |  memory: 2g" },
  ];
